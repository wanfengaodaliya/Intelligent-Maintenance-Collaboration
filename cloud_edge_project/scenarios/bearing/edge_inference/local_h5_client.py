...
from scenarios.bearing.edge_inference.h5_probe import default_probe_dir, load_h5_probe_task
try:
    from edge_model.contracts import EDGE_RESULT_VALUES, EDGE_RISK_VALUES
    from edge_model.model_client import ModelInferResult, ReadinessResult
    ...
    if exc.name != "edge_model":
        raise
    from edge_service.src.edge_model.contracts import (
        EDGE_RESULT_VALUES,
        EDGE_RISK_VALUES,
    )
    from edge_service.src.edge_model.model_client import ModelInferResult, ReadinessResult
    from edge_service.src.edge_model.version_store import (
        DEFAULT_MODEL_ROOT,
        read_active_version,
        set_active_version,
        version_dir,
